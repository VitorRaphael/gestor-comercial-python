...
class PagamentoService:
    ...
    def __init__(
        ...
        # Entre o §9.25 e o §9.26 este service recebia também um `CaixaService`,
        # pelo repasse de comissão, que saía da gaveta. A comissão saiu com a
        # taxa de serviço (§9.26): receber pagamento não mexe mais em movimento
        # de caixa nenhum.
    ...
    def conta_para_pagamento(self, comanda_id: int) -> ContaParaPagamento:
        ...
        Uma chamada por recarga da tela: itens, totais e o que já foi pago. Não
        grava nada.
        """
        comanda = self.comandas.buscar(comanda_id)
        itens = [
