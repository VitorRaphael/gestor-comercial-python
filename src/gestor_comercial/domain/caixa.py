...
class Caixa(Base):
    ...
    aberto_por_id: Mapped[int | None] = mapped_column(ForeignKey("usuarios.id"), index=True)
    fechado_por_id: Mapped[int | None] = mapped_column(ForeignKey("usuarios.id"), index=True)
